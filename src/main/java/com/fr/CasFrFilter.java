...
/**
 * cas单点登陆的过滤类
 * 文档地址：https://help.finereport.com/doc-view-974.html
 * 地址：https://git.fanruan.com/demo/example/src/branch/release/10.0/src/main/java/com/fr/FrFilter.java
 */
public class CasFrFilter implements Filter {
